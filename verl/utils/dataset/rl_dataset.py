...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        # Prompt augmentation configuration
        self.prompt_augmentor = None
    ...
    def build_augmented_prompt(self, base_prompt: str) -> str:
        """
        Apply prompt augmentation with instruction hints based on configuration.
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            raw_prompt = self.build_augmented_prompt(raw_prompt)
        ...
        # Preserve sample_id and dataset_name for KG queries
        sample_id = row_dict.get("extra_info", {}).get("sample_id", f"unknown_{index}")
        dataset_name = row_dict.get("extra_info", {}).get("dataset_name", "unknown")
        if need_tools_kwargs and not tools_kwargs:
            logger.warning("tools_kwargs is empty for index {}, data source: {}", index, row_dict["data_source"])
        row_dict["index"] = index
        row_dict["tools_kwargs"] = tools_kwargs
        row_dict["sample_id"] = sample_id
        row_dict["dataset_name"] = dataset_name
        return row_dict
