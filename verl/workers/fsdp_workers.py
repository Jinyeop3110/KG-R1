    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        with torch.no_grad(), torch.autocast(device_type=device_name, dtype=torch.bfloat16):
            ...
            if self.use_remove_padding:
                ...
                output = self.reward_module(input_ids=input_ids_rmpad_int, attention_mask=None, position_ids=position_ids_rmpad, use_cache=False)  # prevent model thinks we are generating
                ...
                output = self.reward_module(input_ids=input_ids_int, attention_mask=attention_mask, position_ids=position_ids, use_cache=False)
